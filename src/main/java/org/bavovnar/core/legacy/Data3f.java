...
public class Data3f extends Data2f implements Serializable {
    ...
    public Data3f(TimestampedData3f t3f) {
        super(t3f.getX(), t3f.getY());
        this.z = t3f.getZ();
    }
    ...
    public Data3f multiply(Data3f data) {
        return new Data3f(this.getX() * data.getX(), this.getY() * data.getY(), this.getZ() * data.getZ());
    }

    public Data3f add(Data3f data) {
        return new Data3f(this.getX() + data.getX(), this.getY() + data.getY(), this.getZ() + data.getZ());
    }
